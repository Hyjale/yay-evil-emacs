...
#+BEGIN_SRC emacs-lisp
  (use-package emacs
    ...
    :config
    (setq frame-title-format '("hyjale") ; Yayyyyy Evil!
...
#+BEGIN_SRC emacs-lisp
  ...
  (load-theme 'atom-one-dark t) ; an orginal theme created by me.
#+END_SRC
...
#+BEGIN_SRC emacs-lisp
  (use-package dashboard
    ...
    (setq dashboard-startup-banner 'logo
          dashboard-banner-logo-title "Hell yeah!"
          dashboard-items nil
